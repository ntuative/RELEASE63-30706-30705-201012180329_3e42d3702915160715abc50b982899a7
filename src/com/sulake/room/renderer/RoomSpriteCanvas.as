package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_593:RoomObjectCache;
      
      private var var_477:Array;
      
      private var var_592:Array;
      
      private var var_1350:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_242 = new Sprite();
         this.var_242.mouseEnabled = false;
         this.var_55 = new Sprite();
         this.var_55.name = "canvas";
         this.var_55.mouseEnabled = false;
         this.var_242.addChild(this.var_55);
         ...
         this.var_241 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         ...
         this.var_593 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_478.x -= param1 - this.var_589;
         this.var_589 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_478.y -= param1 - this.var_590;
         this.var_590 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_786 = true;
            if(this.var_121 != null && !this.var_242.contains(this.var_121))
            {
               this.var_242.addChild(this.var_121);
               this.var_55.mask = this.var_121;
            }
         }
         else if(!param1 && this.var_786)
         {
            this.var_786 = false;
            if(this.var_121 != null && this.var_242.contains(this.var_121))
            {
               this.var_242.removeChild(this.var_121);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_242.numChildren > 0)
            {
               this.var_242.removeChildAt(0);
            }
            this.var_242 = null;
         }
         this.var_55 = null;
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_592.length)
            {
               this.cleanSprite(this.var_592[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_592 = [];
         }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         if(this.var_121 != null)
         {
            this.var_121.graphics.clear();
         }
         else
         {
            this.var_121 = new Sprite();
            this.var_121.name = "mask";
            if(this.var_786)
            {
               this.var_242.addChild(this.var_121);
               this.var_55.mask = this.var_121;
         ...
         this.var_121.graphics.drawRect(0,0,param1,param2);
         this.var_718 = param1;
         this._ht = param2;
      }
      ...
      {
         this.var_593.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(param1 == this.var_2422)
         {
            return;
         }
         this.var_241.compress();
         ...
         if(this.var_718 != this.var_2424 || this._ht != this.var_2423)
         {
            _loc9_ = true;
         }
         if(this.var_55.x != this.var_589 || this.var_55.y != this.var_590)
         {
            this.var_55.x = this.var_589;
            this.var_55.y = this.var_590;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_477.sortOn("z",0 | 0);
         if(_loc5_ < this.var_477.length)
         {
            this.var_477.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_477[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2424 = this.var_718;
         this.var_2423 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_593.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_593.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_589;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_590;
                  if(_loc19_ < this.var_718 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_477.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_589;
                     _loc17_.y = _loc20_ - this.var_590;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_592.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_477.length)
         {
            return null;
         }
         return this.var_477[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = this.var_241.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_241.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_241.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_241.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_1083 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1722;
         }
         this.var_1722 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1083;
         return this.var_1722;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_718 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1723,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_591.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_591.add(_loc9_,_loc13_);
                     }
                     _loc13_.method_1 = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2420 || param2 != this.var_2421)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_591.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_591.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.method_1,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      {
         if(this.var_332 != null && param1 != null)
         {
            this.var_332.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_332 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_332.getKey(_loc1_);
            _loc3_ = this.var_332.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1350.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
