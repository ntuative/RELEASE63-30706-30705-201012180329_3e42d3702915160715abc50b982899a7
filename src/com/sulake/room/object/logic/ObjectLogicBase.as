package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_309:IRoomObjectController;
      ...
      {
         if(this.var_309 == param1)
         {
            return;
         }
         if(this.var_309 != null)
         {
            this.var_309.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_309 = param1;
            this.var_309.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_309 != null)
            {
               this.var_309.setLocation(param1.loc);
               this.var_309.setDirection(param1.dir);
            }
         }
      }
   }
