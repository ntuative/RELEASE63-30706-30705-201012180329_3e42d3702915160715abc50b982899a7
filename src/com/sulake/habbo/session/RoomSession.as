package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_1820:int = 2500;
      ...
      private var var_968:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_968 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_968.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_205 && this._connection != null)
         {
            this._state = RoomSessionEvent.const_83;
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1211));
         this.var_1210.add(this.var_1211,getTimer());
         ++this.var_1211;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1210.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_1820)
            {
      ...
      {
         return this.var_968 as IUserDataManager;
      }
