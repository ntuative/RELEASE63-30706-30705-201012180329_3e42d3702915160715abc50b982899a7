package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      private static var var_1250:String = "%";
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2114 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_1546 = (param2 & 0) > 0;
         if(!this.var_1546)
         {
            lock();
         }
      ...
      private function fillParams(param1:String, param2:Dictionary) : String
      {
         ...
         while(_loc3_ < 10)
         {
            _loc4_ = param1.indexOf(var_1250);
            if(_loc4_ < 0)
            {
               break;
            }
            _loc5_ = param1.indexOf(var_1250,_loc4_ + 1);
            if(_loc5_ < 0)
            {
               break;
            }
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_1546)
            {
               if("false" == this._configuration.getKey("use.default.localizations","false"))
               {
                  ...
                  events.addEventListener(LocalizationEvent.const_151,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_151,this.onLocalizationLoaded);
         if(this._configuration.keyExists("external.override.texts.txt"))
         {
            ...
            events.addEventListener(LocalizationEvent.const_151,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_151,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         return this.var_2114[Math.max(0,param1 - 1)];
      }
   }
}
