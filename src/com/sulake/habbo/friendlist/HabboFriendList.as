package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_608.stop();
            this.var_608.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_608 = null;
         }
         ...
         if(this.var_115)
         {
            this.var_115.release(new IIDHabboMessenger());
            this.var_115 = null;
         }
         ...
         if(this.var_1056)
         {
            this.var_1056.release(new IIDAvatarRenderManager());
            this.var_1056 = null;
         }
         if(this.var_903)
         {
            this.var_903.release(new IIDHabboNotifications());
            this.var_903 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_740)
         {
            this.var_740.release(new IIDSessionDataManager());
            this.var_740 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1802 = new OpenedToWebPopup(this);
         }
         this.var_1802.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_338.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      {
         var _loc2_:IAvatarImage = this.var_1056.createAvatarImage(param1,AvatarScaleType.const_80,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_115 = param2 as IHabboMessenger;
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1056 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_903 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_338 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_91.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_1045,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_367,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_91.addFriend(new Friend(_loc4_));
         }
         this.var_388 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_608)
         {
            this.var_608 = new Timer(120000);
            this.var_608.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_608.start();
         }
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_367);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_388.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_317));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_338.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_338.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_388.findTab(FriendListTab.const_90).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_338.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_388.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1803.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_388.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_740 || !this.var_338)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_740.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_338.vipLimit;
         }
         else if(this.var_740.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_338.clubLimit;
         }
         if(_loc2_ > this.var_338.limit)
         {
            this.var_338.limit = _loc2_;
         }
      }
