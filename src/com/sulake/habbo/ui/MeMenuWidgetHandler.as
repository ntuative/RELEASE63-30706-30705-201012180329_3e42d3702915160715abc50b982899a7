   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_788,this.onFigureUpdate);
            }
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_518,this.onHelpTutorialEvent);
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_788,this.onFigureUpdate);
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_983,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_901,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_518,this.onHelpTutorialEvent);
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1288)
            {
               ...
               this.var_1612 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1612;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1060,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_731);
         _loc1_.push(RoomWidgetDanceMessage.const_714);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_628);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_649);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_734);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_696);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_793);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_659);
         _loc1_.push(RoomWidgetStopEffectMessage.const_560);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1419);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1058);
         _loc1_.push(RoomWidgetToolbarMessage.const_567);
         _loc1_.push(RoomWidgetToolbarMessage.const_717);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_318);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1296);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_992);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_686);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_677);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_695);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1305);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_773);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_733);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_656);
         _loc1_.push(RoomWidgetClothingChangeMessage.const_380);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_677:
               ...
               break;
            case RoomWidgetWaveMessage.const_731:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_714:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_628:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_734:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_659:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1075)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_182,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_793:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1056:
                        this._catalog.openCatalogPage(CatalogPageName.const_1344,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1086:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_290);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1521:
                        this._inventory.toggleInventoryPage(InventoryCategory.const_76);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1363:
                        break;
                     default:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_696:
            case RoomWidgetStopEffectMessage.const_560:
            ...
            case RoomWidgetToolbarMessage.const_567:
               ...
               break;
            case RoomWidgetToolbarMessage.const_717:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_530,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_318:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_496));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_695:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_339,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_773:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_339,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_733:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_339,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_656:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_402));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_380:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_673));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_798));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_518:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_429));
         }
      }
