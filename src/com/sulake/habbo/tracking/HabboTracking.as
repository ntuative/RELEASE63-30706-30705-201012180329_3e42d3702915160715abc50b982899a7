package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private var var_180:IHabboFriendList;
      
      private var var_1041:IHabboWindowManager;
      ...
      private var var_566:FramerateTracker = null;
      
      private var var_233:LatencyTracker = null;
      
      private var var_564:LagWarningLogger = null;
      
      private var var_565:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_566 = new FramerateTracker();
         this.var_233 = new LatencyTracker();
         this.var_564 = new LagWarningLogger();
         this.var_565 = new ToolbarClickTracker(this);
         this.var_1298 = new Array(const_854);
         var _loc4_:int = 0;
         while(_loc4_ < const_854)
         {
            this.var_1298[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1478,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1469,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1400,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_750,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1041)
            {
               this.var_1041.release(new IIDHabboWindowManager());
               this.var_1041 = null;
            }
            if(this.var_279)
            {
            ...
            if(this.var_180)
            {
               ...
               {
                  Component(this.var_180).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_180).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_180).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_180).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_180).events.removeEventListener(HabboFriendListTrackingEvent.const_317,this.onFriendlistTrackingEvent);
               }
               this.var_180.release(new IIDHabboFriendList());
               this.var_180 = null;
            }
            if(this.var_152)
            {
               if(!this.var_152.disposed)
               {
                  this.var_152.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_152.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_152.release(new IIDHabboHelp());
               this.var_152 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            ...
            if(this._configuration)
            {
               ...
               {
                  this.var_564.configure(this._configuration);
               }
               if(this.var_566 != null)
               {
                  this.var_566.configure(this._configuration);
               }
               if(this.var_565 != null)
               {
                  this.var_565.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_151);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_561,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_212,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_160,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_202,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_634,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_64,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_460,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_564 != null)
            {
               this.var_564.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_634)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1480);
         }
         else if(param1.type == HabboHotelViewEvent.const_460)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1295);
         }
         else if(param1.type == HabboHotelViewEvent.const_64)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1333);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1332);
               break;
            case HabboCommunicationEvent.const_561:
               this.trackLoginStep(HabboLoginTrackingStep.const_1316,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_202:
               this.trackLoginStep(HabboLoginTrackingStep.const_202);
         }
         if(this._communication)
         {
      ...
      {
         this.var_1041 = IHabboWindowManager(param2);
         if(this.var_1041)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1298)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1046);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1046,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_180 = param2 as IHabboFriendList;
         Component(this.var_180).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_180).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_180).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_180).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_180).events.addEventListener(HabboFriendListTrackingEvent.const_317,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_317:
      ...
      {
         this.var_152 = param2 as IHabboHelp;
         this.var_152.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_152.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2281)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1399);
            this.var_2281 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_750,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_300,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_279 = param2 as IAdManager;
         this.var_279.events.addEventListener(AdEvent.const_525,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_565)
         {
            this.var_565.track(param1.iconName);
         }
      }
      ...
      {
         this.var_564.chatLagDetected(param1);
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_459 > -1 && _loc2_ < this.var_459)
         {
            ++this.var_1633;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1633);
         }
         if(this.var_459 > -1 && _loc2_ - this.var_459 > 15000)
         {
            ++this.var_1632;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1632);
         }
         this.var_459 = _loc2_;
         if(this.var_234 != null)
         {
            this.var_234.update(param1,this.var_459);
         }
         if(this.var_233 != null)
         {
            this.var_233.update(param1,this.var_459);
         }
         if(this.var_566 != null)
         {
            this.var_566.trackUpdate(param1,this,this.var_459);
         }
         if(this.var_564 != null)
         {
            this.var_564.update(this.var_459);
         }
      }
   }
}
