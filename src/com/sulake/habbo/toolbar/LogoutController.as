package com.sulake.habbo.toolbar
{
   ...
   public class LogoutController
   {
      ...
      private const const_1545:int = 10;
      ...
      private function createWindow(param1:String) : IWindow
      {
         ...
         _loc3_.x = _loc4_.width - _loc3_.width - this.const_1545;
         _loc3_.y = this.const_1545;
         return _loc3_;
      }
      ...
      private function showConfirmation() : void
      {
         if(!this.var_529)
         {
            this.var_529 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
         }
      }
