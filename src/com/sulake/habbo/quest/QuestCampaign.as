package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_501:Quest;
      
      private var var_286:QuestView;
      ...
      private var var_285:IItemListWindow;
      ...
      public function QuestCampaign(param1:QuestController, param2:String, param3:int)
      {
         ...
         this.var_152 = new QuestHelp(this);
      }
      ...
      private function reset() : void
      {
         ...
         if(this.var_342)
         {
            ...
            {
               this.var_285.removeListItem(_loc1_.view);
               _loc1_.dispose();
            }
            this.var_342 = null;
            this.var_285.destroyListItems();
            this.var_285.removeListItems();
         }
         this.var_501 = null;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1120 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1395 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_285 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.id + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1395.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1395.findChildByName("currency.amount").caption = "${quest_" + this.id + ".currency}";
         ...
         this.var_1121 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1121)
         {
            this.var_1121.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1121.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1121.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_501)
         {
            this.var_501.selected = false;
         }
         if(this.var_152)
         {
            this.var_1120.addChild(this.var_152.view);
         }
      }
      
      public function method_2() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1679);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1395.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_342.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_342)
         {
            this.var_285.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_41 || _loc4_.status == QuestStatusEnum.const_511))
            {
               _loc3_ = _loc4_;
            }
         }
         if(_loc3_)
         {
            ...
            if(this.var_285.maxScrollV > 0)
            {
               this.var_285.scrollV = _loc3_.view.y / this.var_285.maxScrollV;
            }
         }
         else if(this.var_342.length > 0)
         {
            this.activateListItem(this.var_342[0]);
         }
      }
      ...
      public function activateListItem(param1:Quest) : void
      {
         ...
         this.var_501 = param1;
         this.var_501.selected = true;
         this.showQuestData(this.var_501);
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_286 = new QuestView(this,param1);
         this.var_1120.addChild(this.var_286.view);
         this.var_286.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_745.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_745.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_745.splice(_loc4_,1);
            }
         }
      }
      ...
      private function modifyQuestData(param1:QuestMessageData) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.var_342[_loc3_] = _loc5_;
            _loc6_ = this.var_285.getListItemIndex(_loc2_.view);
            this.var_285.removeListItem(_loc2_.view);
            if(_loc6_ > -1)
            {
               this.var_285.addListItemAt(_loc5_.view,_loc6_);
            }
            else
            {
               this.var_285.addListItem(_loc5_.view);
            }
            if(this.var_501 == _loc2_)
            {
