package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1854:int = 10;
      ...
      private const const_1582:uint = 4.293848814E9;
      
      private const const_1581:uint = 4.294967295E9;
      
      private const const_1853:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1590 = _loc1_.stuffTypes;
            this.var_738 = _loc1_.boxTypes;
            this.var_737 = _loc1_.ribbonTypes;
            this.var_1111 = this.var_1590[0];
            this.var_336 = this.var_738[0];
            this.var_335 = this.var_737[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_335 < 0)
         {
            this.var_335 = this.var_737.length - 1;
         }
         if(this.var_335 > this.var_737.length - 1)
         {
            this.var_335 = 0;
         }
         if(this.var_336 < 0)
         {
            this.var_336 = this.var_738.length - 1;
         }
         if(this.var_336 > this.var_738.length - 1)
         {
            this.var_336 = 0;
         }
         var _loc1_:int = this.var_738[this.var_336] * 1000 + this.var_737[this.var_335];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_87.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1111,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1382 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1590;
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_738[this.var_336]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_737[this.var_335]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_87,this.var_1381,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_87.offerId,this.var_1381);
               this.dispose();
               break;
            case "cancel_button":
         ...
         switch(param1.type)
         {
            case WindowEvent.const_104:
               ...
               for each(_loc7_ in this.var_205)
               {
                  ...
                  if(_loc5_.length >= this.const_1854)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2511 = _loc3_.text;
               break;
            case WindowMouseEvent.const_39:
               ...
               break;
            case WindowKeyboardEvent.const_818:
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_539:
               this.showSelectors(false);
               break;
            case WindowEvent.const_748:
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_607 == null)
         {
            this.var_607 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_607.procedure = this.suggestionsEventHandler;
         }
         if(this.var_246 == null || this.var_607 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_607.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1853;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1582) : uint(this.const_1581);
      }
