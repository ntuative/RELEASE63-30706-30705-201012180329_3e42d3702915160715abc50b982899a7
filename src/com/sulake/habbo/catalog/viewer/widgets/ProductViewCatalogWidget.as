package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1719:BitmapData;
      ...
      private var var_1718:Point;
      
      private var var_476:IItemGridWindow;
      
      private var var_1349:IScrollbarWindow;
      ...
      {
         this.var_881 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1082 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1718 = new Point(this.var_83.x,this.var_83.y);
         this.var_476 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1349 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1719 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_476 != null)
         {
            ...
            this.var_476.destroyGridItems();
         }
         if(this.var_1349 != null)
         {
            this.var_1349.visible = false;
         }
         ...
         this.var_881.text = _loc4_;
         this.var_1082.text = _loc5_;
         this.var_881.height = this.var_881.textHeight + 5;
         this.var_1082.y = this.var_881.y + this.var_881.height;
         this.var_1082.height = Math.max(130,this.var_1082.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_415:
                  _loc6_ = this.var_1719.clone();
                  if(this.var_476 != null)
                  {
                     this.var_476.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_476,this.var_1349,this.var_1552);
                     this.var_476.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_215:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_261,AvatarAction.const_452);
                              _loc16_.appendAction(AvatarAction.const_264,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2419)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2419 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1718.x;
            this.var_83.y = this.var_1718.y;
            if(param3 != null)
            {
