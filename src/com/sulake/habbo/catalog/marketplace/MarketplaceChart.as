package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         this.var_583 = 0;
         for each(_loc4_ in this.var_170)
         {
            if(_loc4_ > this.var_583)
            {
               this.var_583 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_583).toString().length - 1);
         this.var_583 = Math.ceil(this.var_583 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_583.toString();
         _loc3_.draw(_loc6_);
         this.var_1074 = param1 - _loc6_.textWidth - 2;
         ...
         while(_loc10_ <= 5)
         {
            ...
            _loc9_.graphics.lineTo(this.var_1074 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_1074,(param2 - this.var_868) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_1074 + this.var_1074 / -this.var_2668 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_868 - this.var_868 / this.var_583 * this.var_170[param1];
      }
      
      public function get available() : Boolean
      {
         return this._x && this.var_170 && this._x.length > 1;
      }
   }
}
