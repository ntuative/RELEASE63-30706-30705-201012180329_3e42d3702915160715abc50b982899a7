package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1228:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1374:XML;
      
      private static var var_1376:XML;
       
      
      private var var_1775:Number = 4.294967295E9;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1376 == null)
         {
            ...
            var_1376 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1775 == 4294967295)
            {
               this.var_1775 = _loc1_.color;
            }
            _loc1_.color = const_1228;
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1402;
            }
         }
      }
      ...
      {
         this.var_53 = navigator.catalog.windowManager.buildFromXML(var_1376) as IItemListWindow;
         if(this.var_53 == null)
         {
