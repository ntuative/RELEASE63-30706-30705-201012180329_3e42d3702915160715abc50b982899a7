package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1085:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1084 = this.var_1725.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1084)
         {
            this.var_1084.procedure = this.onButtonClick;
         }
         this.var_1085 = this.var_1725.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1085)
         {
            this.var_1085.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_243 >= this._localizations.length - 1)
         {
            this.var_1085.disable();
         }
         else
         {
            this.var_1085.enable();
         }
         if(this.var_243 <= 0)
         {
            this.var_1084.disable();
         }
         else
         {
            this.var_1084.enable();
         }
      }
      ...
      {
         ++this.var_243;
         this.var_243 = Math.min(this.var_243,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_243;
         this.var_243 = Math.max(this.var_243,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_243][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_243][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_243][1]).value;
