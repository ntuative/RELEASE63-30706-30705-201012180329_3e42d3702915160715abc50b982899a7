package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1053;
         if(this.var_1053 < this.var_855.length)
         {
            _loc1_ = this.var_855[this.var_1053] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_855.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_385)
         {
            ...
            this.var_385 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_385.center();
            this.var_385.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_855[this.var_1053] as Dictionary;
