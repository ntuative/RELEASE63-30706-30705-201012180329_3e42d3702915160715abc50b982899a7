package com.sulake.habbo.window.utils
{
   ...
   public class AlertDialog implements IAlertDialog, INotify
   {
      ...
      private static const const_1202:String = "_alert_button_list";
      
      private static const const_710:String = "_alert_button_ok";
      
      private static const const_859:String = "_alert_button_cancel";
      
      private static const const_858:String = "_alert_button_custom";
      
      private static const const_1441:String = "_alert_text_summary";
      ...
      public function AlertDialog(param1:IHabboWindowManager, param2:XML, param3:String, param4:String, param5:uint, param6:Function)
      {
         ...
         var _loc7_:IItemListWindow = this._window.findChildByName(const_1202) as IItemListWindow;
         if(_loc7_)
         {
            if(!(param5 & 0))
            {
               _loc8_ = _loc7_.getListItemByName(const_710);
               _loc8_.dispose();
            }
            if(!(param5 & 0))
            {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "_alert_button_ok":
                  ...
                  {
                     this.var_257(this,new WindowEvent(WindowEvent.const_183,null,null));
                  }
                  break;
               case "header_button_close":
                  if(this.var_257 != null)
                  {
                     this.var_257(this,new WindowEvent(WindowEvent.const_681,null,null));
                  }
            }
         }
      }
      ...
      public function getButtonCaption(param1:int) : ICaption
      {
         ...
         if(!this._disposed)
         {
            switch(param1)
            {
               case HabboAlertDialogFlag.const_710:
                  _loc2_ = this._window.findChildByName(const_710) as IInteractiveWindow;
                  break;
      ...
      public function set summary(param1:String) : void
      {
         ...
         if(this._window)
         {
            ITextWindow(this._window.findChildByTag("DESCRIPTION")).text = this.var_1820;
         }
      }
