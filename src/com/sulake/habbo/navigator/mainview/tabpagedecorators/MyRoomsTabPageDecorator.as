package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_456:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_456 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_456.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_456 == null ? 0 : int(this.var_456.selection);
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         ...
         if(param1 == 2)
         {
            return Tabs.const_565;
         }
         if(param1 == 3)
         {
            return Tabs.const_645;
         }
         if(param1 == 4)
         {
            return Tabs.const_775;
         }
         return Tabs.const_246;
      }
   }
}
