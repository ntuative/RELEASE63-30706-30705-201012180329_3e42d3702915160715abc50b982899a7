package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_344 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_374);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_737);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_242,Tabs.const_374,"" + _loc3_);
         }
      }
   }
}
