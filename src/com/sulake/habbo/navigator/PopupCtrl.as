package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      {
         this.var_390 = new Timer(500,1);
         this.var_326 = new Timer(100,1);
         super();
         ...
         this.var_326.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_326)
         {
            this.var_326.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_326.reset();
            this.var_326 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_48 == null)
         {
            this.var_48 = IWindowContainer(this._navigator.getXmlWindow(this.var_1230));
         ...
         this.var_48.x = _loc2_.x + this.var_2369 + param1.width;
