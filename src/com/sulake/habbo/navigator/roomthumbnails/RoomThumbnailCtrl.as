package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1668:IButtonWindow;
      
      private var var_2354:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1667 = IButtonWindow(this.find("bg_tab"));
         this.var_1666 = IButtonWindow(this.find("top_tab"));
         this.var_1668 = IButtonWindow(this.find("obj_tab"));
         this.var_2354 = IWindowContainer(this.find("tile_grid"));
         this.var_2353 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1667,this.onBgTabButton);
         Util.setProcDirectly(this.var_1666,this.onTopTabButton);
         Util.setProcDirectly(this.var_1668,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1667,this.var_62.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1666,this.var_62.mode != ThumbnailEditorModel.const_56);
         this.setEnabled(this.var_1668,this.var_62.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2353;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2354;
         _loc1_.visible = true;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_55,HabboWindowStyle.const_34,HabboWindowParam.const_57,new Rectangle(0,0,param1.width,66)));
