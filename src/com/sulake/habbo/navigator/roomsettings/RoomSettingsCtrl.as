package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1128:ICheckBoxWindow;
      
      private var var_609:ICheckBoxWindow;
      
      private var var_1822:IWindowContainer;
      
      private var var_1397:IWindowContainer;
      ...
      private var var_1131:IWindowContainer;
      
      private var var_2547:ITextWindow;
      
      private var var_2548:ITextWindow;
      ...
      {
         this.var_343 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_343));
         if(this.var_1131 != null)
         {
            this.var_1131.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_343)
         {
            return;
         }
         this.var_76 = param1;
      ...
      {
         if(param1 != this.var_343 || this.var_1123 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1123 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1484)
         {
         ...
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1413)
         {
            this.var_1126.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1371)
         {
            this.setTagError(this.var_846,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_847,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1268)
         {
            this.setTagError(this.var_846,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_847,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1254)
         {
            this.var_918.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_539,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_613,this.onDoorModePasswordUnselect);
         ...
         Util.setProc(this._window,"remove_all_flat_ctrls",this.method_12);
         ...
         this.var_846 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_847 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_918 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1127 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1125 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1130 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1128 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_609 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1822 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1397 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1129 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1124 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1824 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1396 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_247 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1131 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2547 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2548 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1823 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1823.procedure = this.onSwitchView;
         this.var_1131.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1824.visible = this._inRoom;
         this.var_2548.visible = this.var_502;
         this.var_2547.visible = !this.var_502;
         if(this.var_502)
         {
            this.var_1124.visible = true;
            this.var_1396.visible = false;
            this.refreshFlatControllers();
            this.var_1124.height = Util.getLowestPoint(this.var_1124) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1129.visible = true;
            this.var_1396.visible = true;
            this.var_1397.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1397.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1129.height = Util.getLowestPoint(this.var_1129) + 4;
         }
         this.var_1823.text = !!this.var_502 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1822.name,this.var_1397.name,this.var_1129.name,this.var_1124.name,this.var_1396.name,this.var_1824.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_918.setText("");
         this.var_1127.setText("");
         ...
         switch(_loc1_.doorMode)
         {
            case RoomSettingsData.const_164:
               ...
               break;
            case RoomSettingsData.const_107:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_107);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_846,_loc1_.tags[0]);
         this.setTag(this.var_847,_loc1_.tags[1]);
         if(this.var_1125)
         {
            if(_loc1_.allowPets)
            {
               this.var_1125.select();
            }
            else
            {
               this.var_1125.unselect();
            }
         }
         if(this.var_1130)
         {
         ...
         if(this.var_1128)
         {
            ...
            {
               this.var_1128.select();
            }
            else
            {
               this.var_1128.unselect();
            }
         }
         if(this.var_609)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_107;
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_534;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_107)
         {
            _loc8_ = this.var_918.getText();
            _loc9_ = this.var_1127.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_918.clearErrors();
               this.var_1127.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1125.isSelected;
         _loc2_.allowFoodConsume = this.var_1130.isSelected;
         _loc2_.allowWalkThrough = this.var_1128.isSelected;
         _loc2_.hideWalls = this.var_609.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_846,_loc2_.tags);
         this.addTag(this.var_847,_loc2_.tags);
         this.clearErrors();
         this.var_1123 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_343);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_76.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_343]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_34,HabboWindowParam.const_57,new Rectangle(0,0,100,20)));
      }
      ...
      private function method_12(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_343));
      }
