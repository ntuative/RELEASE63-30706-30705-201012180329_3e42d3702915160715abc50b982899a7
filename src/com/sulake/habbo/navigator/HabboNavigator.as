package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_562:RoomInfoViewCtrl;
      
      private var var_1033:RoomCreateViewCtrl;
      ...
      private var var_2701:Dictionary;
      ...
      private var var_918:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_562 = new RoomInfoViewCtrl(this);
         this.var_1033 = new RoomCreateViewCtrl(this);
         this.var_2254 = new RoomThumbnailRenderer(this);
         this.var_918 = new GuestRoomPasswordInput(this);
         this.var_308 = new GuestRoomDoorbell(this);
         this.var_388 = new Tabs(this);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_562.registerToolbarEvents();
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_272.startSearch(Tabs.const_249,Tabs.const_375,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_272.startSearch(Tabs.const_265,Tabs.const_246);
         this.var_388.getTab(Tabs.const_265).tabPageDecorator.tabSelected();
      }
