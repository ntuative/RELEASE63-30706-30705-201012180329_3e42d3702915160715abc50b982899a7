package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_510:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_148.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_129,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1554,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1554,"/");
         ...
         {
            dispatchEvent(new Event(const_510));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_127.removeEventListener(SSOTicket.const_360,this.onParsedTicketSuccess);
            this.var_127.removeEventListener(SSOTicket.const_294,this.onParsedTicketFailure);
            this.var_127 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_127.addEventListener(SSOTicket.const_360,this.onParsedTicketSuccess);
         this.var_127.addEventListener(SSOTicket.const_294,this.onParsedTicketFailure);
      }
