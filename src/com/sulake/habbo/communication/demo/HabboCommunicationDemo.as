package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2168:PseudoRandom;
      ...
      private var var_197:HabboHotelView;
      
      private var var_1264:String = "";
      
      private const const_1554:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_553 = param1;
            this.var_44.initConnection(HabboConnectionType.const_230);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_93,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_197 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_197.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this._habboConfiguration.getKey("use.sso.ticket") == "1";
         this.var_553 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1579 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2170 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_197 == null)
         {
            this.var_197 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_44.mode = HabboConnectionType.const_102;
            if(this.var_553)
            {
               this.var_44.initConnection(HabboConnectionType.const_230);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_510,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_44.mode = HabboConnectionType.const_926;
            }
         }
         this.var_44.initConnection(HabboConnectionType.const_230);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_561);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2168 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_44.mode)
         {
            case HabboConnectionType.const_102:
               ...
               this.var_197.loadBannerImage(_loc7_ + "?token=" + this.var_1264,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_926:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1516:
               this.var_831 = this.generateRandomHexString(30);
               this.var_449 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_449.init(this.var_831);
               _loc8_ = this.var_449.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_449.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_449.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2168);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1579,this.var_2170));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1554,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_553 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_553);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_160);
         }
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_202);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2169)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1264);
         ...
         this.var_449 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_449.init(_loc14_);
            _loc15_ = this.var_449.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_831 = _loc14_;
            }
