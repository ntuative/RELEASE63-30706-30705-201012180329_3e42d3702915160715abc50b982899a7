package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1807:Boolean = true;
      
      private var var_1387:int = -1.0E9;
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc9_.moveType)
               {
                  case SlideObjectMessageData.const_1016:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1105:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_975,_loc3_.status);
         }
      }
