package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1587:int = 16777216;
      ...
      private var var_1817:int = 16777216;
      ...
      {
         var _loc1_:int = this.var_2681 * this.var_1818 + this.var_2682;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1817;
         this.var_1818 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1817 * param2);
      }
   }
}
