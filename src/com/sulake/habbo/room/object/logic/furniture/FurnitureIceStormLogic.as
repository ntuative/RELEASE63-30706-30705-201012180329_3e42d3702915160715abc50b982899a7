package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         {
            this.var_1451 = _loc2_;
            this.var_1963 = param1.extra;
            this.var_951 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_951 > 0 && param1 >= this.var_951)
         {
            this.var_951 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1451,String(this.var_1451),this.var_1963);
