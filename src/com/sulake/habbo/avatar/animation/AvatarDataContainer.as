package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1437:Number = 1.0;
      
      private var var_1438:Number = 1.0;
      
      private var var_1435:Number = 1.0;
      ...
      {
         super();
         this.var_1551 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2120 = parseInt(_loc2_,16);
         this.var_2121 = parseInt(_loc3_,16);
         ...
         this.var_1712 = new ColorTransform(this.var_1437,this.var_1438,this.var_1435,this._alphaMultiplier);
         this.var_1009 = this.generatePaletteMapForGrayscale(this.var_2121,this.var_2120);
      }
      ...
      {
         return this.var_1009.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1009.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1009.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1009.getValue("alphas") as Array;
      }
