package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1250:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1251:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_740:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1139:AvatarEditorHandler;
      ...
      private var var_924:IFigureData;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_504)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init() : void
      {
         ...
         if(!this.var_172)
         {
            ...
            this.var_616["null"] = new FigureData(this);
            this.var_616["null"] = new FigureData(this);
            _loc1_ = this.var_616["null"];
            _loc2_ = this.var_616["null"];
            _loc1_.loadAvatarData(const_1250,FigureData.const_73);
            _loc2_.loadAvatarData(const_1251,FigureData.FEMALE);
            this.var_91 = new Map();
            this.var_504 = new Map();
            this.var_91.add(AvatarEditorFigureCategory.const_595,new BodyModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_42,new HeadModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_234,new TorsoModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_692,new LegsModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_1033,new HotLooksModel(this));
            this.var_504.add(AvatarEditorSideCategory.const_98,new WardrobeModel(this));
            this.var_504.add(AvatarEditorSideCategory.const_501,new ClubPromoModel(this));
            this.var_172 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_616[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_924.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_924.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_249 == null)
            {
               this.var_249 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_34,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_249.addChild(this._view.window);
               if(param5)
               {
                  this.var_249.center();
               }
            ...
            this.var_249.visible = !this.var_249.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_595);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_504.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_740 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_503 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_924 = this.var_503.getFigureData(AvatarType.const_105);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1139 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_616[this.var_854];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1404 != null)
         {
            ...
            this.var_1404.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1833;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1138 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1249)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1421.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_503.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_503.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1518)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1138 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1138 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_504.getValue(AvatarEditorSideCategory.const_98);
      }
