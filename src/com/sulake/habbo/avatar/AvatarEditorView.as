package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1881:int = 6710886;
      ...
      private var var_485:ITabSelectorWindow;
      ...
      private var var_2449:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1090 = [];
         this.var_1357 = [AvatarEditorFigureCategory.const_595,AvatarEditorFigureCategory.const_42,AvatarEditorFigureCategory.const_234,AvatarEditorFigureCategory.const_692,AvatarEditorFigureCategory.const_1033,AvatarEditorFigureCategory.const_98];
         super();
         ...
         if(var_1421 == null)
         {
            ...
            var_1421 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_400 = new Timer(1000);
         this.var_400.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1357;
         }
         for each(_loc6_ in param4)
         {
            this.var_1090.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1357);
         }
         if(param1.length != this.var_1090.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1090.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2448 = this.canChangeOutfit();
            this.var_400.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_485 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_485.method_3 - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_485.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1090.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_485.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_485.method_3)
               {
                  this.var_485.getSelectableAt(_loc6_).x = this.var_485.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1357;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1751 == AvatarEditorSideCategory.const_98 || this.var_2449))
         {
         ...
         this.setViewToCategory(this.var_303);
      }
      ...
      {
         if(this.var_1751 == AvatarEditorSideCategory.const_98)
         {
            this.var_2449 = false;
            this.setSideContent(AvatarEditorSideCategory.const_674);
         }
         else
         {
            this.setSideContent(AvatarEditorSideCategory.const_98);
         }
      }
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_674:
               break;
            case AvatarEditorSideCategory.const_501:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_501);
               break;
            case AvatarEditorSideCategory.const_98:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_98);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_303 = param1;
         this.var_485.setSelected(this.var_485.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_486)
         {
            ...
            this.var_486 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_486.procedure = this.stripClubDialogEventProc;
            this.var_486.center();
         }
         else
         {
