package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_223:AvatarImageCache;
      
      private var var_560:int = 0;
      
      private var var_1440:int = 0;
      
      private var var_568:AvatarFigureContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_568 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_568.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1189 = this.var_1190;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_42)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1189);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_560);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_568,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1189 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_560);
                  _loc20_ = this.var_84;
                  _loc21_ = 1;
                  switch(this.var_84)
                  {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_560);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_568,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_80)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_560);
                  _loc21_ = this.var_84;
                  _loc22_ = 1;
                  switch(this.var_84)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_452 = this.var_452 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_778);
         this.getCache().resetBodyPartCache(this.var_778);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1188 = this._structure.sortActions(this.var_289);
         ...
         {
            this.var_680 = this._structure.getCanvasOffsets(this.var_1188,this._scale,this.var_84);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1188)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_326)
               {
                  this.var_779 = true;
               }
