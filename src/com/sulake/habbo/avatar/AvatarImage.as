package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      protected var var_680:Array;
      
      protected var _assets:AssetAliasCollection;
      
      protected var var_223:AvatarImageCache;
      
      protected var var_568:AvatarFigureContainer;
      
      protected var var_514:IAvatarDataContainer;
      
      protected var var_289:Array;
      
      protected var var_39:BitmapData;
      
      private var var_778:IActiveActionData;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_568 = param3;
         this.var_223 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1134,const_1133);
         this.var_289 = new Array();
         this.var_778 = new ActiveActionData(AvatarAction.const_322);
         this.var_778.definition = this._structure.getActionDefinition(const_1132);
         this.resetActions();
      ...
      {
         param2 += this.var_1440;
         if(param2 < AvatarDirectionAngle.const_1063)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_560,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_271.length == 1 && this.var_84 == this.var_1894)
         {
            return this.var_84 + this.var_452 + this.var_560 % 4;
         }
         if(this.var_271.length == 2)
         {
            for each(_loc1_ in this.var_271)
            {
               ...
               {
                  return this.var_84 + this.var_452 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_560 % 11;
                  return this.var_84 + "_" + this.var_1894 + this.var_452 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2241 || param2 != this.var_2242 || param1 != this.var_2243)
         {
            this.var_2241 = param3;
            this.var_2242 = param2;
            this.var_2243 = param1;
            this.var_1611 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_560);
         ...
         {
            if(this.var_514.paletteIsGrayscale)
            {
               ...
               this.var_39 = _loc13_;
               this.var_39.paletteMap(this.var_39,this.var_39.rect,new Point(0,0),this.var_514.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_560);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_289.push(new ActiveActionData(param1,param2,this.var_560));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_256 = this.var_778;
         this.var_256.definition = this.var_778.definition;
         this.resetBodyPartCache(this.var_778);
         return true;
      }
      ...
      private function isHeadTurnPreventedByAction() : Boolean
      {
         ...
         for each(_loc3_ in this.var_271)
         {
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_452 = "";
         this.var_271 = this._structure.sortActions(this.var_289);
         if(this.var_271 == null)
         {
            this.var_680 = new Array(0,0,0);
            if(this.var_1286 != "")
            {
               _loc1_ = true;
               this.var_1286 = "";
         ...
         {
            this.var_680 = this._structure.getCanvasOffsets(this.var_271,this._scale,this.var_84);
            for each(_loc4_ in this.var_271)
            {
               this.var_452 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_264)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1287 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1287 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1286 != this.var_452)
            {
               _loc1_ = true;
               this.var_1286 = this.var_452;
            }
         }
         this.var_1187 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_271)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_779 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1440 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_514 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_267 || _loc1_.actionType == AvatarAction.const_220 || _loc1_.actionType == AvatarAction.const_326)
               {
                  this.var_779 = true;
               }
            }
