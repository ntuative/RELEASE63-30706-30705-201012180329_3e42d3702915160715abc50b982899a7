package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1619:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_355 = new Dictionary();
         this.var_1619 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2256 = parseInt(param1.@precedence);
         this.var_2261 = String(param1.@activepartset);
         this.var_2262 = String(param1.@assetpartdefinition);
         this.var_2258 = String(param1.@lay);
         this.var_637 = String(param1.@geometrytype);
         this.var_2179 = Boolean(parseInt(param1.@main));
         this.var_2257 = Boolean(parseInt(param1.@name_3));
         this.var_2259 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2260 = _loc6_;
            }
            else
            {
               this.var_1619[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_355[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_680.getValue(param1) == null)
         {
            this.var_680.add(param1,new Map());
         }
         var _loc4_:Map = this.var_680.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_680.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1619[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2260;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_355[param1];
         if(_loc2_ != null)
         {
