package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_879:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_649.width,this.var_649.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_649,this.var_649.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1081.width,this.var_1081.height,true,0);
            _loc5_ = this.var_1081.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_879.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_878.width,this.var_878.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_878,this.var_878.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_879)
            {
               switch(this.var_879.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_52:
                     _loc4_.style = HabboIconType.const_743;
                     _loc4_.visible = true;
               }
            }
            else
