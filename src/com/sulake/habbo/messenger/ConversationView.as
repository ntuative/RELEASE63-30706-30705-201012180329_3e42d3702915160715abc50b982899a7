package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1192:int = 10;
      ...
      private var var_2274:IScrollbarWindow;
      
      private var var_1629:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_115 = param1;
         this.var_1629 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_53 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2274 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_115.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_849 + const_1191)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_115.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1192;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_457 == null || _loc1_.id != this.var_457.id)
         {
            this.var_457 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_457.followingAllowed)
         {
            this.var_1629.enable();
         }
         else
         {
            this.var_1629.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_53.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_457.messages.length - const_849);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_457.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_457.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_115.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_676 || param3.type == Message.const_631 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_457.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_115.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_115.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_115.send(new FollowFriendMessageComposer(this.var_457.id));
      }
      ...
      private function onCloseButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_115.conversations.closeConversation();
         this.var_115.messengerView.refresh();
      }
      
      private function getChatBgColor(param1:int) : uint
      {
         if(param1 == Message.const_676)
         {
            return 4294967295;
         }
         if(param1 == Message.const_631)
         {
            return 4292801535;
         }
         if(param1 == Message.const_968)
         {
            return 4294927974;
         }
         ...
         if(param1 == Message.const_637)
         {
            return 4293454056;
         }
         if(param1 == Message.const_1100)
         {
            return 4288269465;
         }
         return 4291611852;
