package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1547:int = 0;
      ...
      {
         this.var_303 = this._defaultViewId;
         this.var_436 = new Array();
         this.var_537 = new Array();
         super();
         this._component = param1;
         this._assetLibrary = param2;
         this._windowManager = param3;
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012180239));
         this._toolbar = param5;
         this.var_92 = new Map();
         this.var_92.add(HabboHelpViewEnum.const_1281,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_170,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_456,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_305,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_233,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_741,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_356,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_627,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_227,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_92.add(HabboHelpViewEnum.const_902,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_92.add(HabboHelpViewEnum.const_894,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_701,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_436.length == 0 || param1 != this.var_303)
            {
               this.var_436.push(this.var_303);
            }
         }
         this.var_303 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_303);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_227:
               this.showUI(HabboHelpViewEnum.const_227);
               break;
            case CallForHelpResultEnum.const_971:
               this.showUI(HabboHelpViewEnum.const_894);
               break;
            case CallForHelpResultEnum.const_1077:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_92.getValue(HabboHelpViewEnum.const_170) as IHelpViewController;
      ...
      {
         return this.var_92.getValue(this.var_303);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1513 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1512;
         this._window.width = _loc1_.width + this.var_1513;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_436.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_303 == HabboHelpViewEnum.const_170)
         {
            return;
         }
         if(this.var_537.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_537.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_537.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_302.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_537[1],this.var_537[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_537[0],this.var_537[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_303 == HabboHelpViewEnum.const_170 || this.var_436.length == 0)
         {
            return;
         }
         if(this.var_302 == null)
         {
            ...
            this.var_302 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_302.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_302.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_302 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_302 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_302 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
