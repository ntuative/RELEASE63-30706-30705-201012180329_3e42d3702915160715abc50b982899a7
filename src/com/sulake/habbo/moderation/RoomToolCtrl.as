package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_891:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_45.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_343));
         Logger.log("BEGINNING TO SHOW: " + this.var_343);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1366;
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_343);
         if(param1.flatId != this.var_343)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_343);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_891 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1353 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1352 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_45.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_45,WindowTracker.const_633,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_891.isSelected);
         this.var_45.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1479,_loc2_,this.var_471.text,"",""));
         if(this.var_1353.isSelected || this.var_1352.isSelected || this.var_891.isSelected)
         {
            this.var_45.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1353.isSelected,this.var_1352.isSelected,this.var_891.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1270);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1390);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_45.initMsg.roomMessageTemplates[this.var_1087.selection];
         if(_loc3_ != null)
         {
            this.var_584 = false;
