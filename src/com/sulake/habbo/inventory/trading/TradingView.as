package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_866:uint = 4284532064;
      
      private static const const_867:uint = 2577770;
      
      public static const const_1028:int = 0;
      
      public static const const_905:int = 1;
      
      public static const const_923:int = 2;
      ...
      private var var_393:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_393 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_182)
            {
               this.var_182.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_182.stop();
               this.var_182 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1699 = this.createMinimizedWindow();
         }
         if(!this.var_2399)
         {
            return this.var_66;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_866) : uint(const_867);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_866) : uint(const_867);
            }
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_182 = new Timer(1000,3);
            this.var_182.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_182.reset();
         this.var_182.repeatCount = 3;
         this.var_182.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_182.currentCount));
         if(this.var_182.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_145)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_890)
            {
            ...
            this.var_393.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_517);
            this.var_393.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_393.hideDelayed();
         }
      }
