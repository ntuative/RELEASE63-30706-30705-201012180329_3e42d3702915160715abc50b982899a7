package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2686:Number = 0.0;
      ...
      protected var var_1889:int = 0;
      
      protected var var_1890:int = 0;
      
      protected var var_1165:Number;
      
      protected var var_1163:Number;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_98 = 0;
         this.var_90 = 0;
         this._horizontal = param2 == WindowType.const_334;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_151 = var_419 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_323,WindowStyle.const_581,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_45,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_521,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_308,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_462,this.containerEventHandler);
         this.resizeOnItemUpdate = this.var_1164;
      }
      ...
      {
         return new Rectangle(this.var_625 * this.maxScrollH,this.var_624 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_625 = param1;
            this._container.x = -this.var_625 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_72);
            dispatchEvent(new WindowEvent(WindowEvent.const_486,this,null));
         }
      }
      ...
      {
         this.var_2686 = Math.max(param1,0);
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            ...
            {
               this._container.setParamFlag(WindowParam.const_403,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_521,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_308,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_462,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_172:
               if(this.var_1162)
               {
                  this.var_1165 = this.var_1889 - _loc3_;
                  this.var_1163 = this.var_1890 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1165 != 0 && this.var_98 != 0)
                     {
                        this.scrollH += this.var_1165 / this.var_98;
                     }
                  }
                  else if(this.var_1163 != 0 && this.var_90 != 0)
                  {
                     this.scrollV += this.var_1163 / this.var_90;
                  }
                  this.var_1889 = _loc3_;
                  this.var_1890 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_167:
               if(this.var_1162)
               {
                  if(this._horizontal)
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1165,0);
                  }
                  else
                  {
                     var_16.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1163);
                  }
                  this.var_1162 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_935 && !this.var_508 && this._container)
         {
            this.var_508 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1121,this._spacing,PropertyStruct.const_51,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1120,this.var_935,PropertyStruct.const_53,this.var_935 != const_1526));
         _loc1_.push(new PropertyStruct(const_1119,this.var_509,PropertyStruct.const_53,this.var_509 != const_1525));
         _loc1_.push(new PropertyStruct(const_1122,this.var_1164,PropertyStruct.const_53,this.var_1164 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
