package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_999:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_374)
         {
            this.var_374.removeEventListener(WindowEvent.const_286,this.scrollBarEventProc);
            this.var_374.removeEventListener(WindowEvent.const_253,this.scrollBarEventProc);
            this.var_374 = null;
         }
         if(this.var_999)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_999)
         {
            this.var_999 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return this.var_999;
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_374)
         {
            this.var_374 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_374)
            {
               this.var_374.addEventListener(WindowEvent.const_286,this.scrollBarEventProc);
               this.var_374.addEventListener(WindowEvent.const_253,this.scrollBarEventProc);
            }
         }
         return this.var_374;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_253)
         {
            this.hideScrollBar();
         }
      }
