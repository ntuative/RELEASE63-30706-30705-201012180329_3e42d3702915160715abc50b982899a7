package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_454:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_454 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_107 is BitmapDataAsset)
         {
            ...
            this.var_1283 = BitmapDataAsset(this.var_107).var_1283;
            this.var_1284 = BitmapDataAsset(this.var_107).var_1284;
            if(this._bitmap != null)
            {
               this.var_107 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1283 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1284 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
